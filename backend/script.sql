    ...
    CREATE TABLE PlaniFy.BeneficioEmpleado (
        ...
        FOREIGN KEY (idEmpresa) REFERENCES PlaniFy.Empresa(id),
        FOREIGN KEY (idEmpleado, NombreBeneficio) REFERENCES PlaniFy.Beneficio(idEmpleado, Nombre)
            ON DELETE CASCADE
    );
