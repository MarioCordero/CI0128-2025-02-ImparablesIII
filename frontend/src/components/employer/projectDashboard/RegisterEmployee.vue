<template>
  <div class="page">
    ...
    <div class ="body mt-12"> 
      <div class="neumorphism-card-modal p-7! w-[700px] mx-auto">
        <!-- Step Navigation -->
        <div class="flex justify-center items-center mb-8">
          <div class="flex items-center space-x-8">
            ...
            <div v-for="(step, idx) in stepTitles" :key="idx" class="flex flex-col items-center">
              <div
                :class="[
                  'w-12! h-12! rounded-full! flex items-center justify-center neumorphism-on-small-item',
                  currentTab === idx ? 'bg-[#7476ff]!' : 'bg-gray-300'
                ]"
                @click="goToTab(idx)"
              >
              ...
              <div
                :class="[
                  'w-8! h-1! rounded-full! mt-2 neumorphism-on-small-item',
                  currentTab === idx ? 'bg-[#7476ff]!' : 'bg-gray-300'
                ]"
              ></div>
            </div>
        ...
        <h2 class="text-2xl font-semibold text-gray-700 text-center mb-3">{{ stepTitles[currentTab] }}</h2>
        
        <!-- Project Selection Info -->
        <div v-if="isProjectSelected" class="mb-3 flex justify-center">
          <div class="flex items-center">
            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
            </svg>
            <span>Proyecto seleccionado: <strong>{{ projectDisplayName }}</strong></span>
          </div>
        </div>
        <div class="w-full h-[10px] mb-6 rounded neumorphism-on-small-item"></div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-6">
                <div class="relative">
                  ...
                  <input v-model="formData.primerNombre" type="text" placeholder="Primer Nombre" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.primerApellido" type="text" placeholder="Apellidos" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.telefono" type="tel" placeholder="#### ####" @input="formatTelefono" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.correo" type="email" placeholder="Correo Electrónico" class="neumorphism-input" required />
              ...
              <div class="space-y-6">
                <div class="relative">
                  ...
                  <input v-model="formData.segundoNombre" type="text" placeholder="Segundo Nombre" class="neumorphism-input" />
                </div>
                <div class="relative">
                  <div class="space-x-2 ml-2"><p>Fecha de Nacimiento</p></div>
                  <input v-model="formData.fechaNacimiento" type="date" placeholder="Fecha de nacimiento" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.cedula" type="text" placeholder="Cédula (#-####-####)" @input="formatCedula" class="neumorphism-input" required />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-6">
                <div class="relative">
                  ...
                  <div class="relative">
                    <select v-model="formData.provincia" class="neumorphism-input neumorphism-input-select" required>
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.canton" type="text" placeholder="Cantón" class="neumorphism-input" required />
              ...
              <div class="space-y-6">
                <div class="relative">
                  ...
                  <input v-model="formData.distrito" type="text" placeholder="Distrito" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.direccionParticular" type="text" placeholder="Dirección Particular" class="neumorphism-input" required />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-6">
                <div class="relative">
                  ...
                  <input v-model="formData.departamento" type="text" placeholder="Departamento" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <div class="relative">
                    <select v-model="formData.tipoContrato" class="neumorphism-input neumorphism-input-select" required>
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.puesto" type="text" placeholder="Puesto" class="neumorphism-input" required />
              ...
              <div class="space-y-6">
                <div class="relative">
                  ...
                  <input v-model="formattedSalario" type="text" placeholder="₡0.000" @input="formatSalario" class="neumorphism-input" required />
                ...
                <div class="relative">
                  ...
                  <input v-model="formData.numeroCuentaIban" type="text" placeholder="Número de Cuenta IBAN" class="neumorphism-input" required />
          ...
          <div class="flex justify-between mt-8">
            <button v-if="currentTab > 0" type="button" @click="goToTab(currentTab - 1)" class="neumorphism-button-normal-light flex items-center gap-2">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/>
              </svg>
              <span>Anterior</span>
            </button>
            <button v-else type="button" @click="goBack" class="neumorphism-button-normal-red flex items-center gap-2">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="ml-auto">
              <button v-if="currentTab < 2" type="button" @click="goToTab(currentTab + 1)" class="neumorphism-button-normal-light flex items-center gap-2">
                <span>Siguiente</span>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
                </svg>
              </button>
              <button v-else type="submit" class="neumorphism-button-normal-blue flex items-center gap-2">
                <span>Registrar</span>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
export default {
  ...
  data() {
    return {
      ...
      selectedSection: 'employees' // conecta subheader a sección empleados
    }
  },
  mounted() {
  ...
  watch: {
    '$route.query.section': {
      handler(val) {
        if (val) this.selectedSection = val
      },
      immediate: true
    }
  },
  ...
  methods: {
    ...
    goBack() {
      if (this.isProjectSelected) {
        this.$router.push({
          path: `/dashboard-project/${this.project.id}`,
